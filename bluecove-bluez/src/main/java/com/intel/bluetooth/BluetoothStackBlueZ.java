...
class BluetoothStackBlueZ implements BluetoothStack, DeviceInquiryRunnable, SearchServicesRunnable {
	 ...
	 * 
	 * throw new
	 * UnsupportedOperationException("nativeGetDeviceName() Not supported yet."
	 * ); }
	 */
	 ...
	 * "nativeGetLocalDeviceDiscoverable() Not supported yet."); }
	 */
	 ...
	 * 
	 * throw newUnsupportedOperationException(
	 * "nativeSetLocalDeviceDiscoverable() Not supported yet."); }
	 */
	...
	public boolean setLocalDeviceDiscoverable(int mode) throws BluetoothStateException {
		 ...
		 * if (error != 0) { throw newBluetoothStateException(
		 * "Unable to change discovery mode. It may be because you aren't root"
		 * ); } return true;
		 */
	}
	 ...
	 * 
	 * throw new
	 * IOException("getRemoteDeviceFriendlyNameImpl() Not supported yet."); }
	 */
