...
BLUECOVE_PROJECT_HOME=`dirname ${BLUECOVE_HOME}`/bluecove
BLUECOVE_JAR="${BLUECOVE_PROJECT_HOME}/target/bluecove-${BLUECOVE_VERSION}.jar"
BLUECOVE_GPL_PROJECT_HOME=`dirname ${BLUECOVE_HOME}`/bluecove-gpl
BLUECOVE_GPL_JAR="${BLUECOVE_GPL_PROJECT_HOME}/target/bluecove-gpl-${BLUECOVE_VERSION}.jar"

BLUECOVE_BLUEZ_PROJECT_HOME=`dirname ${BLUECOVE_HOME}`/bluecove-bluez
