 ...
 * <code>ResponseCodes</code> class is returned, the server implementation
 * will send an <code>OBEX_HTTP_INTERNAL_ERROR</code> response to the client.
 * <P>
 ...
 * <code>InputStream</code> from the <code>Operation</code> object passed to
 * the <code>onPut()</code> method. For a PUT request, the application will be
...
public class ServerRequestHandler {
	 ...
	 * <code>onConnect()</code> will always return an
