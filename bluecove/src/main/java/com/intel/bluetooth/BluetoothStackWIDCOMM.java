...
class BluetoothStackWIDCOMM implements BluetoothStack, DeviceInquiryRunnable, SearchServicesRunnable {
	...
	/*
	 * This function may trigger multiple times per inquiry – even multiple times per device – once for the address
	 * alone, and once for the address and the user-friendly name.
	 */
