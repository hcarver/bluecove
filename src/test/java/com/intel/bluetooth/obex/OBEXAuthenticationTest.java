...
public class OBEXAuthenticationTest extends TestCase {
	...
	static public void assertEquals(String message, OBEXAuthentication.Challenge expected, OBEXAuthentication.Challenge actual) {
		assertEquals(message + " realm", expected.realm, actual.realm);
		assertEquals(message + " userID", expected.userID, actual.userID);
		assertEquals(message + " access", expected.access, actual.access);
	...
	static public void assertEquals(String message, OBEXAuthentication.DigestResponse expected, OBEXAuthentication.DigestResponse actual) {
