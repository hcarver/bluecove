...
public class BlueCoveImpl {
    ...
    /**
     * API that can be used to configure BlueCove properties instead of System properties. Should be used before stack
     * initialized. If <code>null</code> is passed as the <code>value</code> then the property will be removed.
     * 
     * @param key
     * @param value
     * 
